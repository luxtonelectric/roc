...
const props = defineProps({gameData: {type: Object, default: () => ({})},username: String, playerData: {type: Object, default: () => ({phones: []})}, phoneData: Object, socket: Socket, error: String, callData: {type: Object, default: () => ({})}})
